...
python dadi/afsPlots/afsPrinter.py --dadi_syn_file $syn --dadi_nonsyn_file $nonsyn --dadi_genic_file $genic --dadi_intergenic_file $intergenic --ms_file dadi/ms/ms_$num_indiv\_1000_s$num_snps --out $out
