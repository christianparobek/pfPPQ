...
vcftools --vcf vcfs/our_goods_UG.pass.vcf --keep cp_groups/cp2.txt --recode --out vcfs/our_goods_cp2 # split out cp2
...
bedtools intersect -a vcfs/our_goods_cp2.recode.vcf -b beds/liftover.bed > vcfs/cp2_intersected.vcf # itersect cp2 vcf
